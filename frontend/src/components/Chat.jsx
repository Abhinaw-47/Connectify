  ...
  if (isUserLoading) {
    return (
      <Box minHeight="100vh" display="flex" alignItems="center" justifyContent="center"
        sx={{ background: 'linear-gradient(135deg, #000000 0%, #2a003f 100%)' }}>
      ...
      {showUserList && (
        <Box
          ...
          sx={{
            ...
            backdropFilter: 'blur(4px)', px: 2, py: 2
          }}
        >
            ...
            {users.map((user) => (
              <ListItemButton
                ...
                sx={{
                  ...
                  background: selectedUser?._id === user._id
                    ? 'linear-gradient(135deg, #3b82f6, #9333ea)' : 'transparent',
                  '&:hover': {
              ...
              >
                ...
                <ListItemText
                  ...
                  secondary={<Typography variant="caption" color={onlineUsers.includes(user._id) ? 'lightgreen' : '#aaa'}>
